                  ...
                  <div class="card mb-4">
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                      ...
                      <div class="card-footer">
                        <!-- Form to trigger the download -->
                        <form method="post" action="downloadRecord.php" target="_blank">
                          <!-- Pass current parameters as hidden fields -->
                          <input type="hidden" name="admissionNumber" value="<?php echo $_POST['admissionNumber'] ?? ''; ?>">
                          <input type="hidden" name="type" value="<?php echo $_POST['type'] ?? ''; ?>">
                          <input type="hidden" name="singleDate" value="<?php echo $_POST['singleDate'] ?? ''; ?>">
                          <input type="hidden" name="fromDate" value="<?php echo $_POST['fromDate'] ?? ''; ?>">
                          <input type="hidden" name="toDate" value="<?php echo $_POST['toDate'] ?? ''; ?>">
                          <button type="submit" name="action" value="download" class="btn btn-success btn-sm">Download Attendance (XLS)</button>
                        </form>
