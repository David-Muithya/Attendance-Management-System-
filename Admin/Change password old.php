...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (mysqli_query($conn, $updateQuery)) {
        ...
        $message = "Your password for Attendance Management System has been changed. Your new password is: <b>$newPassword</b>";
        ...
        if ($mail_sent) {
            ...
            $error_message = "Password updated successfully, but failed to send email after $retry_count attempts. Please try again later.";
        }
